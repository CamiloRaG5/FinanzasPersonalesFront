...
export function RegisterPage() {
  ...
  const passwordRequirements = useMemo(() => {
    ...
    return {
      ...
      number: hasNumber,
      allValid: hasMinLength && hasUpperCase && hasLowerCase && hasNumber
    };
  }, [formData.password]);
            ...
            <div>
              ...
              {formData.password.length > 0 && (
                <div className="mt-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-xs text-gray-700 font-medium mb-2">Requisitos de contraseña:</p>
                  <div className="space-y-1">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`text-xs ${
                        passwordRequirements.minLength ? 'text-green-600' : 'text-gray-600'
                      }`}>
                        Mínimo 8 caracteres
                      </span>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`text-xs ${
                        passwordRequirements.lowerCase ? 'text-green-600' : 'text-gray-600'
                      }`}>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`text-xs ${
                        passwordRequirements.number ? 'text-green-600' : 'text-gray-600'
                      }`}>
                        Al menos un número
                      </span>
                    </div>
